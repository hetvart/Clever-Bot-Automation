module.exports = {
  ...
  'Test': function(client){
    ...
    // console.log('Logining to gmail with credentials:', '\n', 'id: ' + client.globals.testEmailLogin, '\n', 'password: ' + client.globals.testEmailPassword)
    // client.getGmailVerificationLink()
    var mainPage = browser.page.mainPage()
    client.end()
  }
};